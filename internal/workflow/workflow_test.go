...
func TestRequiredBytesWithMarginRejectsNegativeMargin(t *testing.T) {
	if _, err := requiredBytesWithMargin(1000, -1); err == nil {
		t.Fatal("expected negative safety margin to be rejected")
	}
}
